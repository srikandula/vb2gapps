...
public class MimeTypes {
	...
	public static final String MIME_APPLICATION_MSWORDDOCX = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
	...
	public static final String MIME_APPLICATION_VND_MSEXCEL_XLSX =  "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
	...
	public static final String MIME_APPLICATION_VND_PRESENTATIONML="application/vnd.openxmlformats-officedocument.presentationml.presentation";
	...
	static {
		mimeTypeMapping = new HashMap<String, String>(200) {
...

			{
				...
				put1("pptx", MIME_APPLICATION_VND_PRESENTATIONML);
				...
				put1("docx", MIME_APPLICATION_MSWORDDOCX);
				put1("xls", MIME_APPLICATION_VND_MSEXCEL);
				put1("xlsx", MIME_APPLICATION_VND_MSEXCEL_XLSX);
