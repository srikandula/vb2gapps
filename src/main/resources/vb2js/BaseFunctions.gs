...
/**
 * Returns Date
 * @param {string|date} d the string date
 * @return {date} The date object as result
 */
function CDate(d) {
  var nd = new Date(d);
  return nd;
...
/**
 * Returns Double
 * @param {number|n} n the n date
 * @return {double} Float number as result
 */
function CDbl(n) {
    return parseFloat(n);
};
...
/**
 * Returns Long
 * @param {number|l} n the n date
 * @return {long} Float number as result
 */
function CLng(l) {
    return parseFloat(l);
};
...
/**
 * Returns String
 * @param {string,string,string|s,f,r} 
 * @return {string} string as result
 */
